...
t_ref, E_ref = read_slow_data('./data/old/cork/ref_cork.txt')
t_sam, E_sam = read_slow_data('./data/old/cork/sam_cork.txt')
...
window = zero_padding(window, int(round(zero_idx / 4)), int(round(zero_idx * 3 / 4)))
E_ref *= window
E_sam *= window
